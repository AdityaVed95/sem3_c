...
// Sem3_COA/boothes_version2/boothes_version2.c
...
int MAX_BITS_SIZE=256; // this number determines the number of bits taken to represent any signed number in this program
...
int main()
{
    ...
    printf("Enter the Integer numbers from -128 to +127 only inorder to multiply them\n\n");
