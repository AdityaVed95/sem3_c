//
// Created by Aditya Ved on 01/09/22.
//
...
void pop(int *, int *);
void peek(int *, int *);
void display_tos_to_bos(int *, int *);
...
void push(int *ptr_to_bos, int *ptr_to_tos_variable)
{
    if(*(ptr_to_tos_variable) == MAX-1)
    {
...
void pop(int * ptr_to_bos, int * ptr_to_tos_variable)
{
...
void display_tos_to_bos(int * ptr_to_bos, int * ptr_to_tos_variable)
{
    int i;
