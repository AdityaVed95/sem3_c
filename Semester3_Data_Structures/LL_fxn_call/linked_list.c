...
int main()
{
    ...
    while (dummy == 1)
    {
        ...
        printf("Enter the data (char) to be added to the %d th node\n",(i));
        fflush(stdout);
        scanf("%c",&data_input);
        fflush(stdin);
        ...
        else
        {
            ...
            ptr_to_node_only->character1 = data_input;
    ...
    number_of_nodes =delete_given_node(linked_list_ptr,number_of_nodes);
    traverse_linked_list(linked_list_ptr);

    number_of_nodes = insert_node(linked_list_ptr,number_of_nodes);
    traverse_linked_list(linked_list_ptr);
